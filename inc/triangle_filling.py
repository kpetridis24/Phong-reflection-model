...
def render_phong(verts2d, center, depth, vcolors, normals, camera_pos, mat, lights, Ia, img):
        ...
        for x in range(x_min, x_max + 1):
            ...
            if cross_counter % 2 != 0:
                if x < img.shape[0] and x >= 0 and y < img.shape[1] and y >= 0:
                    ...
                    img[x, y] = new_color + \
                                lt.ambient_light(mat, new_color, Ia) + \
                                lt.diffuse_light(center, new_normal, new_color, mat, lights) + \
                                lt.specular_light(center, new_normal, new_color, camera_pos, mat, lights)
